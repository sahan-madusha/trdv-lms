...
export enum UserRolesEnum {
  ...
  head_office_accountant = "head_office_accountant",
...
export enum ProductSearchType {
  ...
  AGENCY_PRODUCTS = "AGENCY_PRODUCTS",
  EMPLOYEE_LIST_BY_ROLE_AND_NAME = "EMPLOYEE_LIST_BY_ROLE_AND_NAME",
  ORDER_LIST_BY_AGENCY_ID = "ORDER_LIST_BY_AGENCY_ID"
}
