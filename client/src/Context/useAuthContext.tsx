...
export const AuthProvider = ({ children }: { children: ReactNode }) => {
  ...
  useEffect(() => {
    if (
      ...
      user?.userRole === UserRolesEnum.head_office_accountant ||
      user?.userRole === UserRolesEnum.head_office_manager
    ) {
      setNavigationPath("admin");
    } else if (
      user?.userRole === UserRolesEnum.agency ||
      user?.userRole === UserRolesEnum.agency_accountant ||
      user?.userRole === UserRolesEnum.agency_manager
    ) {
      setNavigationPath("agency");
    } else if (user?.userRole == UserRolesEnum.salesman) {
      setNavigationPath("salesman");
    } else {
